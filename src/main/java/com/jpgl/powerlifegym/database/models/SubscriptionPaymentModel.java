...
@Entity
@Table(name = "subscription_payment", schema = "prueba", catalog = "")
public class SubscriptionPaymentModel {
    ...
    @Basic
    @Column(name = "id_payment_method", nullable = false, insertable=false, updatable=false)
    ...
    @JsonIgnore
    @ManyToOne
    @JoinColumn(name = "id_payment_method", referencedColumnName = "id", nullable = false)
    private PaymentMethodModel paymentMethodByIdPaymentMethod;
    @JsonIgnore
    @ManyToOne
    ...
    public PaymentMethodModel getPaymentMethodByIdPaymentMethod() {
        return paymentMethodByIdPaymentMethod;
    }

    public void setPaymentMethodByIdPaymentMethod(PaymentMethodModel paymentMethodByIdPaymentMethod) {
