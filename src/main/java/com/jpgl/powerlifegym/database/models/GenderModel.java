...
@Entity
@Table(name = "genders", schema = "prueba", catalog = "")
public class GenderModel {
    ...
    private Collection<ClientModel> clientsById;
    @JsonIgnore
    @OneToMany(mappedBy = "gendersByIdGender")
    private Collection<ProductModel> clothesById;
    @JsonIgnore
    @OneToMany(mappedBy = "gendersByIdGender")
    ...
    public Collection<ClientModel> getClientsById() {
        return clientsById;
    }

    public void setClientsById(Collection<ClientModel> clientsById) {
        this.clientsById = clientsById;
    }

    public Collection<ProductModel> getClothesById() {
        return clothesById;
    }

    public void setClothesById(Collection<ProductModel> clothesById) {
