...
public class PresentationModel {
    ...
    private Collection<SupplementModel> supplementsById;
    ...
    public Collection<SupplementModel> getSupplementsById() {
        return supplementsById;
    }

    public void setSupplementsById(Collection<SupplementModel> supplementsById) {
